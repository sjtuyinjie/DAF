...
class myresnet(nn.Module):
    def __init__(self, max_material_num, max_type_num, max_name_num, residual_latent_ch):
        ...
        net.conv1 = nn.Conv2d(2, 64, kernel_size=7, stride=2, padding=3, bias=False)  # out 2048
        # in_channel = 2048
        ...
        self.material_prediction = nn.Linear(2048, max_material_num)
        self.type_prediction = nn.Linear(2048, max_type_num)
        self.residual_latent_mean = nn.Linear(2048, residual_latent_ch)
        self.residual_latent_logvar = nn.Linear(2048, residual_latent_ch)
        self.position_latent = nn.Linear(2048, 2)  # We have a 2 channel positional representation
