...
class Options():
    ...
    def initialize(self):
        ...
        parser.add_argument('--apt', default='object_ours8', type=str)
        ...
        parser.add_argument('--epochs', default=10000, type=int) # Total epochs to train for
        parser.add_argument('--resume', default=0, type=bool_flag) # Load weights or not from latest checkpoint
        parser.add_argument('--batch_size', default=64, type=int)#80
