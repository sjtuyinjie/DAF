...
def test_net(rank, other_args):
    ...
    weights = torch.load("//data/vision/torralba/scratch/chuang/Projects/nap_vision/results/object_ours8/00110.chkpt",
                         map_location=map_location)#  110  0.17   160 0.17
    ...
    with torch.no_grad():
        ...
        for IDX in range(10160):  # 1016
            ...
            # if (scale_num_gt[0] > 0.5):
            #     print(scale_num_gt[0])
            #     IDX -= 1
            # else:
