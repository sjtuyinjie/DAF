...
def test_net(rank, other_args):
    ...
    weights = torch.load("//home/zdp21n5/projects/aresnettest/results/apartment_1///00200fourier.chkpt",
    ...
    with torch.no_grad():
        ...
        for IDX in range(10):  # 1016
            ...
            for x_offset in np.arange(-5, 5, 0.2):
                for y_offset in np.arange(-5, 5, 0.2):
                    ...
                    reconstruct = decoder(total_latent)
        ...
        with open("stft_500.pkl", "wb") as f:
